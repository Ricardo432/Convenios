...
<p >DIRECCIÓN DE LA INSTALACIÓN: <B><?php echo "$line[2]"?></B><br>TIPO DE INSTALACIÓN: <?php echo"$line[7]"?><br>MEGAS: <?php echo"$line[8]"?><br>FECHA DE CORTE: Dia 15 de cada mes<br>DIAS DE PAGO: Del 14 al 16 de cada mes.</p>
...
<?php if($line[7]=='Completa'){
	echo "<tr><td>Radio Ubiquiti</td><td></td><td></td></tr><tr><td>Routher MikroTik</td><td></td><td></td></tr>";}else{echo "<tr><td>Routher TP Link</td><td></td><td></td></tr>";}?></table>
	</center>
