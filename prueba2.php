...
<p align='left'>COMODANTE: JOSE JESUS GARCIA PAREDES</p><p>COMODATARIO: <?php echo "$line[1]"; ?><br>Se identifica con:_______________________________________________________.<br>CORREO ELECTRONICO: <?php echo "$line[4]"; ?><br>CEL: <?php echo "$line[3]"; ?></p>
<p >Entre las partes, COMODANTE Y COMODATARIO, mediante este documento suscriben un convenio de comodato (prestamos temporal de equipos), que se regirá por los siguientes puntos:</p>
...
<p >DIRECCIÓN DE LA INSTALACIÓN: <B><?php echo "$line[2]"?></B><br>TIPO DE INSTALACIÓN: <?php echo"$line[6]"?><br>MEGAS: <?php echo"$line[7]"?><br>FECHA DE CORTE: Dia 15 de cada mes<br>DIAS DE PAGO: <?php if (date('j')>15) {
	$res = 15 + (30-date('j'));
}else{
	$res = 15 - date('j');
	}echo $res; ?></p>
...
<?php if($line[6]=='Completa'){
	echo "<tr><td>Radio Ubiquiti</td><td></td><td></td></tr>";}?><tr><td>Routher MikroTik</td><td></td><td></td></tr></table>
	</center>
