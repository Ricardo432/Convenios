...
<p >DIRECCIÓN DE LA INSTALACIÓN: <B><?php echo "$line[2]"?></B><br>TIPO DE INSTALACIÓN: <?php echo"$line[6]"?><br>MEGAS: <?php echo"$line[7]"?><br>FECHA DE CORTE: Dia 15 de cada mes<br>DIAS DE PAGO: Del 14 al 16 de cada mes.</p>
